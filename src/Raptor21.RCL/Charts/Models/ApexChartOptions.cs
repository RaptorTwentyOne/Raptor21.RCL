...
{
    /// <inheritdoc cref="Raptor21.RCL.Charts.Models.IApexChartBaseOptions" />
    public class ApexChartBaseOptions : IApexChartBaseOptions
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.IApexChartBaseOptions.Debug" />
    ...
    /// </summary>
    /// <remarks>
    /// <see cref="Series"/> carries its data as the plain arrays ApexCharts.js expects, so the class needs no
    /// type parameter for the shape of the caller's records.
    /// </remarks>
    public class ApexChartOptions : ApexChartBaseOptions
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Responsive" />
        public List<Responsive> Responsive { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Series" />
    ...
    public class PlotOptionsTreemap
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TreemapColorScale" />
        public TreemapColorScale ColorScale { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TreemapDataLabels" />
    ...
    public class TreemapColorScale
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TreemapRanges" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AnnotationsImage" />
        public List<AnnotationsImage> Images { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AnnotationsPoint" />
        public List<AnnotationsPoint> Points { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AnnotationsText" />
        public List<AnnotationsText> Texts { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AnnotationsXAxis" />
        public List<AnnotationsXAxis> Xaxis { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AnnotationsYAxis" />
    ...
    public class AnnotationsPoint : IAnnotation
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AnnotationsPointImage" />
        public AnnotationsPointImage Image { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Label" />
        public Label Label { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AnnotationMarker" />
    ...
    public class Label
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Style" />
    ...
    public class Style
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Padding"/>
    ...
    public class Chart
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Animations" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Brush" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DropShadow" />
        public DropShadow DropShadow { get; set; }

        /// <summary>
        /// A collection of JavaScript functions to execute on specific interations with the chart. Recommendation is to use events within <c>ApexChart&lt;TItem&gt;</c>. Available keys are:
        /// 
        /// animationEnd,
        /// beforeMount,
        /// mounted,
        ...
        /// You can also set a key application-wide via <c>ApexChartsServiceOptions.LicenseKey</c>.
        /// </summary>
        /// <remarks>
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ChartLocale" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Selection" />
        public Selection Selection { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ChartSparkline" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Toolbar" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Zoom" />
        public Zoom Zoom { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DataReducer" />
        ...
        /// <see cref="Raptor21.RCL.Charts.Models.Renderer.Svg"/> (default) keeps everything as SVG; <see cref="Raptor21.RCL.Charts.Models.Renderer.Canvas"/>
        /// paints the series (and large heatmaps) to a canvas; <see cref="Raptor21.RCL.Charts.Models.Renderer.Auto"/> switches to canvas
        /// above <see cref="RendererThreshold"/>. Axes, grid, tooltips, annotations and exports stay SVG.
        /// </summary>
        public Renderer? Renderer { get; set; }

        /// <summary>
        /// Data-point count above which <see cref="Raptor21.RCL.Charts.Models.Renderer.Auto"/> switches the series layer to canvas.
        /// Added in ApexCharts v6.0.
        /// </summary>
        public double? RendererThreshold { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ChartStreaming" />
        public ChartStreaming Streaming { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Pan" />
        public Pan Pan { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ChartHistory" />
        public ChartHistory History { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ChartPerspectives" />
        public ChartPerspectives Perspectives { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ChartLink" />
        public ChartLink Link { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ChartInk" />
        public ChartInk Ink { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ChartMeasure" />
        public ChartMeasure Measure { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ChartContextMenu" />
    ...
    /// </summary>
    /// <remarks>
    /// Drive it from code via <c>ApexChart&lt;TItem&gt;.UndoAsync</c>, <c>ApexChart&lt;TItem&gt;.RedoAsync</c> and
    /// <c>ApexChart&lt;TItem&gt;.JumpHistoryAsync</c>. See <see cref="Chart.License"/> and
    /// <c>ApexChartsServiceOptions.LicenseKey</c> for licensing.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Capture/apply from code via <c>ApexChart&lt;TItem&gt;.CapturePerspectiveAsync</c>,
    /// <c>ApexChart&lt;TItem&gt;.ApplyPerspectiveAsync</c>, <c>ApexChart&lt;TItem&gt;.PerspectiveToUrlAsync</c>.
    /// </remarks>
    ...
    public class ChartLink
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ChartLinkBins" />
    ...
    /// <c>ApexChart&lt;TItem&gt;.OnAnnotationDragged</c>, <c>ApexChart&lt;TItem&gt;.OnAnnotationEdited</c>,
    /// <c>ApexChart&lt;TItem&gt;.OnAnnotationStyled</c> and <c>ApexChart&lt;TItem&gt;.OnAnnotationDeleted</c> events.
    /// </summary>
    ...
    /// <c>ApexChart&lt;TItem&gt;.StartMeasureAsync</c>, <c>ApexChart&lt;TItem&gt;.StopMeasureAsync</c> and
    /// <c>ApexChart&lt;TItem&gt;.ClearMeasuresAsync</c>; completed measurements raise <c>ApexChart&lt;TItem&gt;.OnMeasured</c>.
    /// </summary>
    public class ChartMeasure
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.MeasureColors" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.MeasureFormat" />
    ...
    public class ChartContextMenu
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ContextMenuLabels" />
        public ContextMenuLabels Labels { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ContextMenuLine" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ExportCSV" />
        public ExportCSV Csv { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ExportSvg" />
        public ExportSvg Svg { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ExportPng" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AnimateGradually" />
        public AnimateGradually AnimateGradually { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DynamicAnimation" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ChartTypeMorph" />
    ...
    public class ChartLocale
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.LocaleOptions" />
    ...
    public class LocaleOptions
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.LocaleToolbar" />
    ...
    public class Selection
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.SelectionFill" />
        public SelectionFill Fill { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.SelectionStroke" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.SelectionXaxis" />
        public SelectionXaxis Xaxis { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.SelectionYaxis" />
    ...
    public class Toolbar
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Tools" />
        public Tools Tools { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ExportOptions" />
    ...
    public class Tools
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ToolCustomIcon" />
    ...
    public class Zoom
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ZoomedArea" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ZoomedAreaFill" />
        public ZoomedAreaFill Fill { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ZoomedAreaStroke" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DataLabelsBackground"/>
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DataLabelsStyle"/>
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DataLabelsAnimate" />
        public DataLabelsAnimate Animate { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DataLabelsCountUp" />
    ...
    public class Fill
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.FillGradient"/>
        public FillGradient Gradient { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.FillImage"/>
        public FillImage Image { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Opacity"/>
        /// <summary>
        /// Opacity of the fill attribute.
        /// </summary>
        public Opacity Opacity { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.FillPattern"/>
        public FillPattern Pattern { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.FillTypeSelections"/>
        /// <summary>
    ...
    public class FillGradient
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.FillGradientStops"/>
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ColorStopsCollection"/>
    ...
    public class FillImage
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ImagePaths"/>
        /// <summary>
    ...
    public class FillPattern
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.FillPatternStyleSelections"/>
        /// <summary>
    ...
    public class Grid
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.GridColumn"/>
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.GridRow"/>
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.GridXAxis"/>
        public GridXAxis Xaxis { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.GridYAxis"/>
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Lines" />
    ...
    public class Legend
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.LegendItemMargin"/>
        public LegendItemMargin ItemMargin { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.LegendLabels"/>
        public LegendLabels Labels { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.LegendMarkers"/>
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.LegendOnItemClick"/>
        public LegendOnItemClick OnItemClick { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.LegendOnItemHover"/>
    ...
    public class Markers
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.MarkersHover"/>
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Size"/>
        /// <summary>
    ...
    public class NoData
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.NoDataStyle"/>
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsArea" />
        public PlotOptionsArea Area { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsBar" />
        public PlotOptionsBar Bar { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsBubble" />
        public PlotOptionsBubble Bubble { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsCandlestick" />
        public PlotOptionsCandlestick Candlestick { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsBoxPlot" />
        public PlotOptionsBoxPlot BoxPlot { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsHeatmap" />
        public PlotOptionsHeatmap Heatmap { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsPie" />
        public PlotOptionsPie Pie { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsPolarArea" />
        public PlotOptionsPolarArea PolarArea { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsRadar" />
        public PlotOptionsRadar Radar { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsRadialBar" />
        public PlotOptionsRadialBar RadialBar { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsTreemap" />
        public PlotOptionsTreemap Treemap { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsLine" />
        public PlotOptionsLine Line { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsScatter" />
        public PlotOptionsScatter Scatter { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsViolin" />
    ...
    public class PlotOptionsLine
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.LineColors" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.BloxPlotColors" />
        public BloxPlotColors Colors { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.BoxPlotPoints" />
    ...
    public class BoxPlotPoints
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PointsColorScale" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ScatterJitter" />
    ...
    public class PlotOptionsViolin
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ViolinPoints" />
    ...
    public class PlotOptionsBar
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsBarColors" />
        public PlotOptionsBarColors Colors { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsBarDataLabels" />
    ...
    public class PlotOptionsBarColors
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsBarColorRange" />
    ...
    public class PlotOptionsBarDataLabels
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.BarTotalDataLabels" />
    ...
    public class BarTotalDataLabels
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.BarDataLabelsStyle" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsCandlestickColors" />
        public PlotOptionsCandlestickColors Colors { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsCandlestickWick" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsHeatmapColorScale" />
    ...
    public class PlotOptionsHeatmapColorScale
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsHeatmapColorScaleRange" />
        public List<PlotOptionsHeatmapColorScaleRange> Ranges { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.HeatmapGradientLegend" />
    ...
    public class HeatmapGradientLegend
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.HeatmapGradientLegendLabelStyle" />
        public HeatmapGradientLegendLabelStyle LabelStyle { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.HeatmapGradientLegendArrow" />
    ...
    public class PlotOptionsPie
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PieDataLabels" />
        /// <remarks>
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PlotOptionsDonut" />
    ...
    public class PieDataLabels
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PieDataLabelsExternal" />
    ...
    public class PieDataLabelsExternal
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PieDataLabelsExternalConnector" />
    ...
    public class PlotOptionsDonut
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DonutLabels" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DonutLabelName" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DonutLabelTotal" />
        public DonutLabelTotal Total { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DonutLabelValue" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PolarAreaRings" />
        public PolarAreaRings Rings { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.PolarAreaSpokes" />
    ...
    public class PlotOptionsRadar
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.RadarPolygons" />
    ...
    public class RadarPolygons
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.RadarPolygonsFill" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.RadialBarDataLabels" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.RadialBarBandsStyle" />
        public RadialBarBandsStyle BandsStyle { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.RadialBarBarLabels" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Hollow" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.RadialBarNeedle" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.Track" />
    ...
    public class RadialBarNeedle
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.RadialBarNeedleAnimation" />
    ...
    ///       <see cref="LineCap"/> to <see cref="Raptor21.RCL.Charts.Models.LineCap.Butt"/> so adjacent bands
    ...
    ///       <see cref="Raptor21.RCL.Charts.Models.LineCap.Round"/> so each band renders as a distinct rounded
    ...
    public class RadialBarBandsStyle
    {
        ...
        /// Use <see cref="Raptor21.RCL.Charts.Models.LineCap.Butt"/> with <see cref="Gap"/> = 0 for a continuous gradient arc
        /// where bands flow into one another. Use <see cref="Raptor21.RCL.Charts.Models.LineCap.Round"/> with a positive
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.RadialBarDataLabelsName" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.RadialBarDataLabelsTotal" />
        public RadialBarDataLabelsTotal Total { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.RadialBarDataLabelsValue" />
    ...
    public class States
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.StatesActive" />
        public StatesActive Active { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.StatesHover" />
        public StatesHover Hover { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.StatesNormal" />
    ...
    public class StatesActive
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.StatesFilter" />
    ...
    public class Stroke
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.CurveSelections"/>
        /// <summary>
    ...
    public class Subtitle
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.SubtitleStyle" />
    ...
    public class Theme
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.ThemeMonochrome" />
    ...
    public class Title
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TitleStyle" />
    ...
    public class Tooltip
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.CustomFunction"/>
        /// <summary>
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TooltipFixed" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TooltipItems" />
        public TooltipItems Items { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TooltipMarker" />
        public TooltipMarker Marker { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TooltipOnDatasetHover" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TooltipStyle" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TooltipX" />
        public TooltipX X { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TooltipY" />
        public TooltipY Y { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TooltipZ" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.TooltipYTitle" />
    ...
    public class XAxis
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AxisBorder" />
        public AxisBorder AxisBorder { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AxisTicks" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AxisCrosshairs" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.XAxisLabels" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AxisTitle" />
        public AxisTitle Title { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AxisTooltip" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.XAxisGroups" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.XAxisGroup" />
        public List<XAxisGroup> Groups { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.XAxisGroupStyle" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.CrosshairsDropShadow" />
        public CrosshairsDropShadow DropShadow { get; set; }

        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.CrosshairsFill" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.CrosshairStroke" />
    ...
    public class CrosshairsFill
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.FluffyGradient" />
    ...
    {
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.DatetimeFormatter" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AxisLabelStyle" />
    ...
    public class AxisTooltip
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AxisTooltipStyle" />
    ...
    public class YAxis
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.YAxisLabels" />
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.YAxisTooltip" />
    ...
    public class AxisTitle
    {
        ...
        /// <inheritdoc cref="Raptor21.RCL.Charts.Models.AxisTitleStyle" />
...
#pragma warning disable CS1591 // Enum values are self-explanatory
    ...
    {
        Normal,
        [EnumMember(Value = "100%")] Percent100
    };
    ...
    public enum LinkOrder
    {
        ...
        [EnumMember(Value = "first-seen")] FirstSeen,
